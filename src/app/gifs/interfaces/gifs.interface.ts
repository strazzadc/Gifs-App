...
const typeMap: any = {
  ...
  Datum: o(
    [
      ...
      {
        json: 'trending_datetime',
        js: 'trending_datetime',
        typ: u(Date, r('TrendingDatetimeEnum')),
      },
      { json: 'images', js: 'images', typ: r('Images') },
      {
        json: 'analytics_response_payload',
        js: 'analytics_response_payload',
        typ: '',
      },
  ...
  Onclick: o([{ json: 'url', js: 'url', typ: '' }], false),
  Images: o(
    [
  ...
  Rating: ['g', 'pg-13'],
  TrendingDatetimeEnum: ['0000-00-00 00:00:00'],
  Type: ['gif'],
};
